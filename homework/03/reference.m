...
table(Y_rtree(index,:).education_num, rtree_label(index,:), 'VariableNames', {'TrueLabels','PredictedLabels'})
...
table(Y_csvm(index,:).salary, csvm_label(index,:), 'VariableNames', {'TrueLabels','PredictedLabels'})
